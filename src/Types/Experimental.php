...
/**
 * Сповіщення фреймворку про експериментальний функціонал.
 *
...
class Experimental extends Exception {

    /**
     * Створити сповіщення про експериментальний функціонал.
     *
    ...
    public function __construct(
        string $message,
        ExceptionDetailsInterface $details = new ExceptionDetails(type: TypesEventsEnum::Experimental),
        int $code = 0,
